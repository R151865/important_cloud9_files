...
# -done thinking to change overall interactor
...
class GetFormInteractor:
    ...
    def get_form(self,
        ...
        order_dtos = self.form_storage.get_order_dtos(user_id=user_id,
                                                      form_id=form_id)
        section_dtos = self.form_storage.get_form_sections_dtos(form_id=form_id)
    ...
    def _is_item_has_order_if_exists_return_order_obj(self, item_id, order_dtos):
